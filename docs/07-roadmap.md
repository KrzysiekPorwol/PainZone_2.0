...
- **M3.6 · Last Set Preview** — inline per-seria: dla serii K „Ostatnio: reps × ciężar / RPE — N dni temu" z serii K ostatniej poprzedniej sesji tego ćwiczenia; brak poprzedniej sesji → „Tym planem trenujesz 1 raz."
